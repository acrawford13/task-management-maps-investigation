...
const Unavailability = ({ calendar_start_time, start_time, end_time, timeIntervals }) => {
  ...
  return <Wrapper rowSpan={duration / timeIntervals} rowOffset={offset / timeIntervals + 1} />;
};
